...
public class PharmacieMetierImpl implements IPharmacieMetier {
	...
	@Override
	public Page<Famille> consulterFamille(String motCle, int p, int s) {
		Page<Famille> pageFamilles=familleRepository.consulterFamillesAvecMotCle("%"+motCle+"%", PageRequest.of(p, s));
		return pageFamilles;
		}
	//method search sous famille avec mot cle
	@Override
	public Page<SousFamille> consulterSousFamille(String motCle, int p, int s) {
		Page<SousFamille> pageSousFamilles=sousFamilleRepository.consulterSousFamillesAvecMotCle("%"+motCle+"%", PageRequest.of(p, s));
		return pageSousFamilles;
		}
	//method list stocks
	@Override
	...
	@Override
	public void deleteProduitStock(Long codeMedic, Long codeStock) {
		StockMedicament stockMedicament=stockMedicamentRepository.searchStockMedic(codeMedic, codeStock);
		stockMedicamentRepository.delete(stockMedicament);
	}
  ...
  //search sousFamilles de famille
  	@Override
  	public Page<SousFamille> consulterSousFamilleDeFamille(String motCle, int p, int s) {
  		Page<SousFamille> pageSousFamilles=sousFamilleRepository.sousFamillesDeFamille(motCle, PageRequest.of(p, s));
  		return pageSousFamilles;
  	}
	...
	@Override
	public Page<LigneCommande> consulterLignesCommandesMedicament(String motCle, int p, int s) {
		return ligneCommandeRepository.listLignesCommandesByMedicament("%"+motCle+"%", PageRequest.of(p, s));
	}
...
//	}
	...
	//delete médicament
	@Override
	public void deleteMedicament(Long code) {
		medicamentRepository.deleteById(code);
	}
